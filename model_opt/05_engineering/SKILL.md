...
description: Phase 5 工程化实践。NPU 模型适配过程中的工程化最佳实践，包括目录规划、一键脚本设计、版本管理、文档维护和用户交互模式。当用户需要：(1) 组织 GPU/NPU 对称目录与脚本、(2) git 版本管理与提交纪律、(3) 维护优化日志/报告、(4) 处理用户反馈交互时触发。执行前参见根 SKILL.md 全流程。
---
